      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-4">
          ...
          <div className="text-center">
            ...
            <CardDescription>Healthcare workers and administrators</CardDescription>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="nurse@healthcenter.gov.gh"
                value={email}
          ...
          <div className="space-y-2 text-sm">
            <p className="font-semibold text-foreground">Try these demo accounts:</p>
            <ul className="space-y-1 text-muted-foreground">
              <li className="flex items-center gap-2">
                <Check size={14} className="text-primary" />
                <span>admin@health.gov.gh</span>
              </li>
              <li className="flex items-center gap-2">
                <Check size={14} className="text-primary" />
                <span>nurse@health.gov.gh</span>
              </li>
              <li className="flex items-center gap-2">
                <Check size={14} className="text-primary" />
                <span>chw@health.gov.gh</span>
              </li>
            </ul>
