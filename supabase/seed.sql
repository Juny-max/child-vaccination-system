...
INSERT INTO children (id, cvcc_id, qr_code_payload, full_name, date_of_birth, gender, birth_weight, birth_length, place_of_birth, delivery_type, blood_type, primary_facility_id, allergies, created_by_user_id) VALUES
  ('c1000000-0000-0000-0000-000000000001', 'CH-2025-001', 'CH-2025-001|Kwame Boateng|2025-07-18', 'Kwame Boateng', '2025-07-18', 'male', 3.2, 49.0, 'Jakpa District Hospital', 'Spontaneous vaginal', 'O+', '11111111-1111-1111-1111-111111111111', ARRAY['Penicillin'], 'c0000000-0000-0000-0000-000000000001'),
  ('c1000000-0000-0000-0000-000000000002', 'CH-2025-002', 'CH-2025-002|Efua Agyeman|2025-02-02', 'Efua Agyeman', '2025-02-02', 'female', 3.0, 48.5, 'Accra Central Hospital', 'Spontaneous vaginal', 'A+', '11111111-1111-1111-1111-111111111111', ARRAY[]::TEXT[], 'c0000000-0000-0000-0000-000000000001'),
  ('c1000000-0000-0000-0000-000000000003', 'CH-2025-003', 'CH-2025-003|Esi Mensah|2024-03-12', 'Esi Mensah', '2024-03-12', 'female', 3.4, 50.0, 'Accra Central Hospital', 'Caesarean section', 'B+', '11111111-1111-1111-1111-111111111111', ARRAY[]::TEXT[], 'c0000000-0000-0000-0000-000000000001'),
  ('c1000000-0000-0000-0000-000000000004', 'CH-2025-004', 'CH-2025-004|Yaw Asare|2025-05-10', 'Yaw Asare', '2025-05-10', 'male', 3.1, 49.2, 'Accra Central Hospital', 'Spontaneous vaginal', 'O+', '11111111-1111-1111-1111-111111111111', ARRAY[]::TEXT[], 'c0000000-0000-0000-0000-000000000001'),
  ('c1000000-0000-0000-0000-000000000005', 'CH-2025-005', 'CH-2025-005|Amina Ibrahim|2025-08-20', 'Amina Ibrahim', '2025-08-20', 'female', 2.9, 47.5, 'Tamale Teaching Hospital', 'Spontaneous vaginal', 'AB+', '22222222-2222-2222-2222-222222222222', ARRAY[]::TEXT[], 'c0000000-0000-0000-0000-000000000002');
...
INSERT INTO vaccination_schedules (vaccine_id, dose_number, schedule_name, due_days_from_birth, is_mandatory, sort_order) VALUES
  -- At birth
  ('b0000000-0000-0000-0000-000000000001', 1, 'At birth', 0, TRUE, 1),   -- BCG
  ('b0000000-0000-0000-0000-000000000002', 1, 'At birth', 0, TRUE, 2),   -- OPV-0
  
  -- 6 weeks
  ('b0000000-0000-0000-0000-000000000003', 1, '6 weeks', 42, TRUE, 3),   -- OPV-1
  ('b0000000-0000-0000-0000-000000000006', 1, '6 weeks', 42, TRUE, 4),   -- Penta-1
  ('b0000000-0000-0000-0000-000000000009', 1, '6 weeks', 42, TRUE, 5),   -- PCV-1
  ('b000000c-0000-0000-0000-000000000000', 1, '6 weeks', 42, TRUE, 6),   -- Rotavirus-1
  
  -- 10 weeks
  ('b0000000-0000-0000-0000-000000000004', 2, '10 weeks', 70, TRUE, 7),  -- OPV-2
  ('b0000000-0000-0000-0000-000000000007', 2, '10 weeks', 70, TRUE, 8),  -- Penta-2
  ('b000000a-0000-0000-0000-000000000000', 2, '10 weeks', 70, TRUE, 9),  -- PCV-2
  ('b000000d-0000-0000-0000-000000000000', 2, '10 weeks', 70, TRUE, 10), -- Rotavirus-2
  
  -- 14 weeks
  ('b0000000-0000-0000-0000-000000000005', 3, '14 weeks', 98, TRUE, 11), -- OPV-3
  ('b0000000-0000-0000-0000-000000000008', 3, '14 weeks', 98, TRUE, 12), -- Penta-3
  ('b000000b-0000-0000-0000-000000000000', 3, '14 weeks', 98, TRUE, 13), -- PCV-3
  
  -- 9 months
  ('b000000e-0000-0000-0000-000000000000', 1, '9 months', 270, TRUE, 14), -- MR-1
  ('b0000010-0000-0000-0000-000000000000', 1, '9 months', 270, TRUE, 15), -- Yellow Fever
  ('b0000011-0000-0000-0000-000000000000', 1, '9 months', 270, TRUE, 16), -- Meningococcal A
  
  -- 18 months
  ('b000000f-0000-0000-0000-000000000000', 2, '18 months', 540, TRUE, 17); -- MR-2
